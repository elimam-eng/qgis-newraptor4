...
from .new_raptor_dialog import NewRaptor4Dialog
import os.path
...
class NewRaptor4:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('NewRaptor4', message)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = NewRaptor4Dialog()
            self.dlg.cmbSpecies.currentTextChanged.connect(self.evt_species_changed)
    ...
    def evt_species_changed(self, species):
